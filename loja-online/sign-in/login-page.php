                ...
                <form class="form" method="POST" action="cadastra_login.php">
                  ...
                  <div class="row">
                    <div class="form-group col-md-8">
                      ...
                      <input class="form-control" type="text" name="nome-cliente" placeholder="Digite o seu nome completo..">
                    </div>
                  ...
                  <div class="row">
                    <div class="form-group col-md-6">
                      <label>CPF</label>
                      <input type="text" name="cpf-cliente" placeholder=___.___.___-__ maxlength="14" class="form-control" onkeydown="javascript: fMasc(this, mCPF);">
                    </div>
                    <div class="form-group col-md-6">
                      <label>Telefone</label>
                      <input type="text" name="tel-cliente" class="form-control" placeholder="(__)____-____" onkeydown="javascript: fMasc(this, mTel)" maxlength="14">
                    </div>
                  ...
                  <div class="row">
                    <div class="form-group col-md-4">
                      <label>CEP</label>
                      <input type="text" name="cep-cliente" class="form-control" onkeydown="javascript:fMasc(this, mCEP);" maxlength="10" placeholder="00.000-000  ">
                    </div>
                    <div class="form-group col-md-4">
                      <label>Cidade</label>
                      <input type="text" name="cidade-cliente" class="form-control" placeholder="Ex:Cidade">
                    </div>
                    <div class="form-group col-md-4">
                      <label>Bairro</label>
                      <input type="text" name="bairro-cliente" class="form-control" placeholder="Ex:Bairro">
                    </div>
                  </div>
                  <div class="row">
                    <div class="form-group col-md-8">
                      <label> Logradouro</label>
                      <input type="text" name="rua-cliente" class="form-control" placeholder="Ex: Sua rua aqui">
                    </div>
                    <div class="form-group col-md-4 pt-4">
                      <label>Número</label>
                      <input type="text" name="numero-cliente" class="form-control" onkeydown="javascript: fMasc(this, mNum)" placeholder="Ex: 000">
                    </div>
                  </div>
                  <div class="row">
                    <div class="form-group col-md-12">
                  ...
                  <div class="row">
                    <div class="form-group col-md-6">
                      <label>Email</label>
                      <input type="email" class="form-control" name="user-email" placeholder="seuemail@email.com">
                    </div>
                    <div class="form-group col-md-6">
                      <label>Crie uma Senha</label>
                      <input type="text" name="pass-cliente" class="form-control" placeholder="Digite a sua senha">
                    </div>
                  </div>
