...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19-Jun-2021 às 01:50
...
(2, 'Maça', '2,00', 'Maça', 7, ''),
(3, 'Pera', '4,00', 'Pera', 7, ''),
(4, 'Carne Bovina', '27,00', 'Descrição', 1, 0x696d6167656d5f70726f64),
(5, 'Toddy', '4,79', 'Toddy', 16, 0x696d6167656d5f70726f64),
(6, 'Cereal Matinal Crunch', '96,00', 'Farinhas integrais (31%) (farinha de trigo integral e farinha de milho integral), açúcar, farinha de arroz (25%), óleo vegetal de palma fracionado, cacau em pó (5%), minerais [ cálcio (carbonato de cálcio), ferro (ferro eletrolítico) e zinco (óxido de zin', 3, 0x696d6167656d5f70726f64),
(7, 'Nescafé Original', '15,00', '\r\nNescafé Original, é o café solúvel extra forte, para quem aprecia começar o dia com uma dose extra de disposição. Ainda mais cremoso com leite, também fica delicioso com água. Disponível nas versões: sachê 50g e vidros de 100g e 200g.', 2, 0x696d6167656d5f70726f64),
(8, 'Acqua Panna sem Gás', '3,00', 'Ela é uma água extremamente leve, a preferida pelas Associações de Sommeliers para acompanhar as degustações de vinhos.', 2, 0x50656e6775696e732e6a7067);
